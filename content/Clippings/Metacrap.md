...
created: 2025-05-23
description: a famous 2001 essay by Cory Doctorow that critiques overly optimistic visions of metadata and semantic web technologies.
tags:
  - clippings
processed: true
public: true
...
> [!NOTE] Highlighted clip from ([original](https://people.well.com/user/doctorow/metacrap.htm))
> Notes and highlights have been added, links have been updated to local links
> I got it originally from here: [R- Metacrap- Putting the torch to seven straw-men of the meta-utopia](https://scalingsynthesis.com/r-metacrap-putting-the-torch-to-seven-straw-men-of-the-meta-utopia/), by way of [[Rob Haisfield]] when reading about [Q- What is a decentralized discourse graph](https://scalingsynthesis.com/q-what-is-a-decentralized-discourse-graph/)
...
> [[Alex Qwxlea]]: the 2001 roots of the documents show
...
→ [[for there to be a truth, there needs to be a standard]]
...
→ [[measuring influences the result]]
→ [[the one measuring influences the result]]
...
paradox → [[unity reduces complexity, which eases measuring, but reduces freedom of thought and expression]]
...
> [[Alex Qwxlea]] in 2025 this has degraded considerably, I see a shift from google to [[LLM|LLMs]]
...
> [[Alex Qwxlea]] in 2025 this conclusion is showing its age
