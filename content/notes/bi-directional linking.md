...
![[pub_bidirectional-link.png|600]] 
>image source [A Short History of Bi-Directional Links](https://maggieappleton.com/bidirectionals)
...
## (Primary) Sources
> A contextual backlink displays not only a reference from another location, but the specific context around that reference
> – [Backlinks can be used to implicitly define nodes in knowledge management systems | Contextual backlinks](https://notes.andymatuschak.org/z2newCwFfd6iZFyf9bgspkbyt1G8wbQxJVgTK?stackedNotes=z3RzQhmjeRxXVAAy81aUSKARwJL8dikdJG4VG)
...
> An excellent expose on backlinks: [A Short History of Bi-Directional Links](https://maggieappleton.com/bidirectionals) – [[Maggie Appleton]]
