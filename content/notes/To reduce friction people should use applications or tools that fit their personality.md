---
title: 🌱 To reduce friction people should use applications or tools that fit their personality
date: 2023-04-16
aliases: 
tags:
  - review
  - psychology
status: seedling
created: 2023-04-19T20:57:18+02:00
updated: 2023-04-20T19:58:55+02:00
sr-due: 2024-11-12
sr-interval: 447
sr-ease: 334
...
## Literature notes 
  ...
  source:: [How to choose the right note-taking app](https://nesslabs.com/how-to-choose-the-right-note-taking-app)
personality type make some apps a better fit
...
- People love to change apps: [[shiny toy syndrome]]
- [[personality types]]
...
----
Old notes, these videos rehash the article mentioned under sources:
  Author:: [[@ali abdal]]
  Source:: https://www.youtube.com/watch?v=wpcVQeF07G4&list=WL&index=4
- gardeners - roam/obsidian
  architects - Notion
  librarian - evernote
- changing apps will be costly (time, effort)
- invest your time in something
- apps for different things

  Starting point, but nothing new
  author:: [[@Danny Hatcher]]
  source:: [3 notetaking personalities - Danny Hatcher - Obsidian Publish](https://publish.obsidian.md/danny-hatcher/Notes/Working/3+notetaking+personalities)
  Started with this one, then got tiagos, originally ALLC

author:: [[@Tiago Forte]]
source:: [YT](https://www.youtube.com/watch?v=f3dDVtJ2sec)
rehash - 3 archetypes
- {{youtube https://www.youtube.com/watch?v=f3dDVtJ2sec}}
- {{youtube-timestamp 45}} 1. Your goals 2. Evaluate the app 3. Know the features

- 3 archetypes of note takers [[Anne-Laure Le Cunff]]:
...
- **Librarian** {{youtube-timestamp 187}}
